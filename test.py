...
llm = GoogleGenerativeAI(model="gemini-1.5-pro", api_key=key)
...
st.markdown('<div class="main-title">AI-Assistive 👀 </div>', unsafe_allow_html=True)
...
st.markdown(
    ...
    <footer style="text-align:left;">
        <p>Powered by <strong>Using Google Gemini API ⛓️‍💥</strong> | Manoj kumar chiluka</p>
    </footer>
    """,
    unsafe_allow_html=True,
)
